...
#+begin_src emacs-lisp
  (use-package consult
  ;; Other good thingsn to bind: consult-ripgrep, consult-line-multi,
  ...
  (use-package consult-projectile
    :after projectile
    :config
    (define-key projectile-mode-map (kbd "C-c p p") 'consult-projectile)) ;; super-charged projectile search
#+end_src
